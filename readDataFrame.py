...
class ReadDataFrame :
    ...
    #Recupèrer le nombre de variable du DataFrame
    def getNbVariables(self):
        return self.dataFrame.shape[1];

    #Recupèrer le nombre d'observation du DataFrame
    def getNbObservations(self):
        return self.dataFrame.shape[0];

    #Recupèrer la liste des variables qualitatives
    ...
    #Recupèrer le nombre de variable qualitative
    def getNbVariablesQualitatives(self):
        return len(self.getListeVariablesQualitatives());

    #Recupèrer la modalité des variables qualitatives
    ...
    #Récupèrer le nombre d'effectif des variables qualitatives
    ...
    #Récupèrer la fréquence d'apparition d'une variable qualitative
    ...
    #Recupèrer la liste des variables quantitatives
    ...
    #Recupèrer le nombre des variables quantitatives
    def getNbVariablesQuantitatives(self):
        return len(self.getListeVariablesQuantitatives());

    #Recupèrer la valeur minimale des variables quantitatives
    ...
    #Recupèrer la valeur maximale des variables quantitatives
    ...
    #Récupèrer la médiane des variables quantitatives
    def getMediane(self):
        valeurMediane = "";
        for i in range(0, self.getNbVariablesQuantitatives()):
    ...
    #Recupèrer la moyenne des variables quantitatives
    def getMoyenne(self):
        valeurMoyenne = "";
        for i in range(0, self.getNbVariablesQuantitatives()):
    ...
    #Recupèrer l'écartType des variables quantitatives
